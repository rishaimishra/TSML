         ...
         <div style="max-width:720px; border:1px solid #dcd7d7; margin:0 0; padding:15px; border-top:none;">
            ...
            <div style="display:block; overflow:hidden; width:100%;">
               <p style="font-family:Arial; font-size:14px; font-weight:500; color:#000;margin-left: 5px;">
                  <span style="font-family:Arial; border-radius:17px;font-size:15px; font-weight:500; color:#FFF; display:inline-block; padding: 7px 12px; background-color: #ffc107;background-image: linear-gradient(326deg, #ffc107 0%, #ffc107 74%); text-decoration:none;"></span>
               </p>  
