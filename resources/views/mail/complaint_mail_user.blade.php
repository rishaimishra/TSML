...
<div style="width: 600px; margin: 0 auto; background: #fff; padding: 0;">
    <table style="width: 100%;">
        ...
        <tr>
            <td style="padding: 0 15px;">
                <p style="font-weight: 400; font-size: 15px; line-height: 1.8; color: rgba(0,0,0,.8);">{{@$data['customer_name']}} complaint against the PO number ({{@$data['po_number']}}) please check it in the portal.<a href="https://esales.tatasteelmining.com/"></a>. </p>
