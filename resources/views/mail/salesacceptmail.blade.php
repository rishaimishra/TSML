...
<div style="width: 600px; margin: 0 auto; background: #fff; padding: 0;">
    <table style="width: 100%;">
        ...
        <tr>
            <td style="padding: 0 15px;">
                <p style="font-weight: 400; font-size: 15px; line-height: 1.8; color: rgba(0,0,0,.8);">Thank you for your patience. Our sales team has reverted to you with an updated price, volume and delivery timeline against your RFQ. You may check the details here.</p>
